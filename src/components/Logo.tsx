...
const Logo = ({ goToHomePage }: ILogoProps) => {
  return (
    <div className="logo" onClick={goToHomePage}>
      ...
      >
        ...
        <defs>
          ...
          <clipPath id="clip0_3265_205">
            <rect width="53.3333" height="48" fill="white" />
          </clipPath>
        </defs>
      </svg>
      <div className="logo-title">Art API</div>
    </div>
  );
};
